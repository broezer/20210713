...
function setup() {
   ...
   setGradient(0, 0 , width , height , b3, b2, b1, X_AXIS);
   push();
   kitten.rectMode(CENTER);
   kitten.fill(0);
   kitten.noStroke();
   kitten.translate(width * 0.5, width * 0.4);
   pop();
  
   image(kitten, 0, 0);
   makeDithered(kitten, 0.8);
...
function draw() {
  ...
  push();
  translate(width * 1,height * -2.5, width * 1.75);
  rotateY(radians(90));
  //rotateZ(radians(45));
  for (let y = 0; y < rows02 - 1; y++) {
        ...
        noFill();
        stroke(t2);
        strokeWeight( (width/400) * 4);
        rect(x*scl02, y*scl02 * 2, scl02, scl02);
        }
    }
  pop();
  
  push();
  translate(width * 1,height * -2.5, width * -2.5);
  rotateY(radians(90));
  //rotateZ(radians(45));
  for (let y = 0; y < rows02 - 1; y++) {
        for (let x = 0; x < cols02; x++) {
  ...
  pop();
   ...
   push();
  translate(width * 1,height * -2.5, width * -6.75);
  rotateY(radians(90));
  //rotateZ(radians(45));
  for (let y = 0; y < rows02 - 1; y++) {
        for (let x = 0; x < cols02; x++) {
